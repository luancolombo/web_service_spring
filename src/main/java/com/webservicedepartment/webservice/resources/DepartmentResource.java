package com.webservicedepartment.webservice.resources;
...
import com.webservicedepartment.webservice.services.DepartmentService;
...
public class DepartmentResource {
	...
	@GetMapping(value = "/{id}")
	private ResponseEntity<Department> findById(@PathVariable Long id) {
